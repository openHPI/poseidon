...
func (_m *apiQuerierMock) Execute(ctx context.Context, jobID string, command string, tty bool, stdin io.Reader, stdout io.Writer, stderr io.Writer) (int, error) {
...
func newApiQuerierMock(t interface {
	mock.TestingT
	Cleanup(func())
}) *apiQuerierMock {
	mock := &apiQuerierMock{}
