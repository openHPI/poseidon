...
func CreateTemplateJob() (base, job *nomadApi.Job) {
	base = nomadApi.NewBatchJob(tests.DefaultRunnerID, tests.DefaultRunnerID, "region-name", templateJobPriority)
	job = nomadApi.NewBatchJob(tests.DefaultRunnerID, tests.DefaultRunnerID, "region-name", templateJobPriority)
